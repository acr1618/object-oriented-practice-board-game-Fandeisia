...
public class FandeisiaGameManager{
    ...
    private static Creature creatureMoving (Creature creature){ // Ajuda nos logs
        return creature;
    }
    ...
    }//todo CHECAR ERRO NULLPOINTEREXCPETION do teste dos profs. listMaisViajadas
    ...
    public void startGame(String[] content, int rows, int columns) throws InsufficientCoinsException{
        ...
        System.out.println("    Ciaturas em START GAME: "+ creatures + "\n");
        System.out.println("    Buracos em START GAME: " + holes + "\n");
        System.out.println("    Tesouros START GAME: " + treasures + "\n");
        ...
        System.out.println("    Criaturas DE?ordenadas " + creatures + "\n");
        setCreaturesSortedList(creatures);
        System.out.println("    Criaturas ordenadas " + creatures + "\n");

        /*A Exception substituirá isso abaixo*/
    ...
    public boolean enchant (int x, int y, String spellName) {
        ...
        if (spellName == null){
            System.out.println("  spellName é null em enchant. Criatura: "+getCreature(x, y).toString());
            return false;
        }
        ...
        if (!c.isFrozen4Ever() && spellName.equals("Congela")) {
            ...
            switch (spellName) {
                ...
                case ("ReduzAlcance"): {
                    // TODO Se reduzir o alcance e o próximo movimento da criatura não for valido.
                    System.out.println("  ReduzAlcance em: "+getCreature(x, y).toString());
                    if (checkBalanceToSpell(getCurrentTeamId(), 1)) {
                        System.out.println("    Tem coin pra pagar.");
                        c.setEnchant(true);
                        System.out.println("    isEnchant true.");
                ...
                case ("DuplicaAlcance"): {
                    System.out.println("  DuplicaAlcance em: "+getCreature(x, y).toString());
        ...
        return false;
    } // todo - CHECAR POSSÍVEIS ERROS NA ATRIBUIÇÃO DE ENFEITIÇADO
    public void processTurn(){
        System.out.println(iterate(logCounter) + " - " + "Entrou em ProcessTurn");
        turnCounter ++;
    ...
    } //todo - CHECAR POSSÍVEIS ERROS NA EXECUÇÃO DOS FEITIÇOS
    ...
    private List<Creature> setCreaturesSortedList(List<Creature> listCreatures) {
        return creatures.stream()
    ...
    public String[][] getSpellTypes(){
        ...
        return new String[][]{
                {"EmpurraParaNorte", "Empurra a criatura 1 casa para Norte", String.valueOf(1)},
                {"EmpurraParaEste", "Empurra a criatura 1 casa para Este", String.valueOf(1)},
                {"EmpurraParaSul", "Empurra a criatura 1 casa para Sul", String.valueOf(1)},
                {"EmpurraParaOeste", "Empurra a criatura 1 casa para Oeste", String.valueOf(1)},
                {"ReduzAlcance", "Reduz alcance da criatura para 1", String.valueOf(2)},
                {"DuplicaAlcance", "Duplica alcance da criatura", String.valueOf(3)},
                {"Congela", "Congela por 1 turno", String.valueOf(3)},
                {"Congela4Ever", "Congela até ser descongelado", String.valueOf(10)},
                {"Descongela", "Descongela", String.valueOf(8)},
        };
    }
